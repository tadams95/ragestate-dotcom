...
// ============================================
// REACTION (postReactions/{postId}_{userId}_{emoji})
// ============================================

/**
 * Emoji reaction on a post
 * @typedef {Object} Reaction
 * @property {string} postId - Post that was reacted to
 * @property {import('./common').UserId} userId - User who reacted
 * @property {string} emoji - The emoji reaction (single emoji)
 * @property {import('./common').UserId} [postOwnerId] - Post owner's ID (for notifications)
 * @property {Date} createdAt - When the reaction was added
 */

/**
 * Aggregated reactions for a post
 * @typedef {Object} AggregatedReactions
 * @property {{[emoji: string]: {count: number, users: string[]}}} reactions - Map of emoji to count and user IDs
 */
