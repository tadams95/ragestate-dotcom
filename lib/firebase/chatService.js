 ...
 */
export function subscribeToMessages(chatId, onUpdate, onError, limitCount = PAGE_SIZE) {
  const messagesRef = collection(db, CHATS_COLLECTION, chatId, MESSAGES_COLLECTION);
 ...
 */
export async function fetchOlderMessages(chatId, lastDoc, limitCount = PAGE_SIZE) {
  const messagesRef = collection(db, CHATS_COLLECTION, chatId, MESSAGES_COLLECTION);
