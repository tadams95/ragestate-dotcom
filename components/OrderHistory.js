      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6">
        <div className="max-w-l">
          {userPurchases.length === 0 ? (
            <h1 className="text-2xl font-bold tracking-tight text-gray-100 text-center">
              No Purchase History
            </h1>
          ) : (
            <>
              ...
              <p className="mt-2 text-sm text-center text-gray-200">
                View your order history. In the future we'll have more here such
                as order status.
              </p>
              <p className="mt-2 text-sm text-center text-gray-200">
                If you have any questions or concerns, email
                contact@ragestate.com or DM @ragestate on IGs
              </p>
              <div className="mt-12 space-y-16 sm:mt-16">
                {userPurchases.map((purchase, index) => (
                  <div
                    key={index}
                    className="space-y-6 border rounded-md p-4  mt-4"
                  >
