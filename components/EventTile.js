...
export default function EventTile({ event }) {
  ...
  return (
    <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg overflow-hidden shadow-lg transform transition duration-300 hover:scale-105 hover:shadow-2xl border border-gray-700/50 mb-8">
