        ...
        <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          ...
          >
            ...
            <button
              type="button"
              onClick={handleClose}
              className="absolute right-3 top-3 rounded-full p-1 text-[var(--text-tertiary)] hover:bg-[var(--bg-hover)] hover:text-[var(--text-primary)]"
            >
            ...
            {success ? (
              ...
              <div className="py-4 text-center">
                <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-[color-mix(in_srgb,var(--success)_10%,transparent)]">
                  <svg
                ...
                <p className="mt-3 text-base font-medium text-[var(--text-primary)]">You're on the list!</p>
              ...
              <>
                <div className="sm:flex sm:items-start">
                  <div className="mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-[var(--accent-muted)] sm:mx-0 sm:h-10 sm:w-10">
                    <EnvelopeIcon className="h-6 w-6 text-[var(--accent)]" />
                  </div>
                ...
                <form onSubmit={handleSubmit} className="mt-5">
                  <input
                    ...
                    required
                    autoComplete="email"
                    className="w-full rounded-md border border-[var(--border-subtle)] bg-[var(--bg-elev-2)] px-4 py-2.5 text-sm text-[var(--text-primary)] placeholder:text-[var(--text-tertiary)] focus:border-[var(--accent)] focus:outline-none focus:ring-1 focus:ring-[var(--accent)]"
                  />
                  <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2">
                    <button
                      type="submit"
                      disabled={submitting || !email}
                      className="inline-flex w-full justify-center rounded-md bg-[var(--accent)] px-3 py-2 text-sm font-semibold text-white shadow-sm hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50 sm:order-2"
                    >
                    ...
                    <button
                      type="button"
                      onClick={handleClose}
                      className="inline-flex w-full justify-center rounded-md bg-[var(--bg-elev-2)] px-3 py-2 text-sm font-semibold text-[var(--text-secondary)] shadow-sm ring-1 ring-inset ring-[var(--border-subtle)] hover:bg-[var(--bg-hover)] sm:order-1"
                    >
                      Maybe Later
                    </button>
                  </div>
