...
function EventSkeleton() {
  return (
    <div className="mb-8 overflow-hidden rounded-lg border border-[var(--border-subtle)] bg-[var(--bg-elev-1)] shadow-lg">
      ...
      <div className="relative h-60 w-full animate-pulse bg-[var(--bg-elev-2)] sm:h-64 lg:h-72" />

      {/* Content - matches EventTile padding and structure */}
      <div className="p-6">
        {/* Title skeleton */}
        <div className="h-7 w-3/4 animate-pulse rounded-md bg-[var(--bg-elev-2)]" />

        {/* Date/time skeleton */}
        <div className="mt-4 flex items-center">
          <div className="mr-2 h-5 w-5 animate-pulse rounded-full bg-[var(--bg-elev-2)]" />
        ...
        <div className="mt-3 flex items-center">
          <div className="mr-1 h-4 w-4 animate-pulse rounded-full bg-[var(--bg-elev-2)]" />
          <div className="h-4 w-40 animate-pulse rounded bg-[var(--bg-elev-2)]" />
        </div>

        {/* Price and capacity skeleton */}
        <div className="mt-4 flex items-center justify-between">
          <div className="h-6 w-14 animate-pulse rounded bg-[var(--bg-elev-2)]" />
