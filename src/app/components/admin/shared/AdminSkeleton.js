...
export function StatCardSkeleton() {
  return (
    <div className="flex animate-shimmer items-center justify-between rounded-lg border border-[var(--border-subtle)] bg-[var(--bg-elev-1)] p-6 shadow-md">
      <div>
    ...
    <tr>
      {Array.from({ length: columns }).map((_, i) => (
        <td key={i} className="whitespace-nowrap px-6 py-4">
          <div className="h-4 w-full max-w-[120px] animate-shimmer rounded bg-[var(--bg-elev-2)]" />
        </td>
      ))}
    </tr>
  );
            ...
            <tr className="bg-[var(--bg-elev-2)]">
              {Array.from({ length: columns }).map((_, i) => (
                <th key={i} className="px-6 py-3">
                  <div className="h-3 w-20 animate-shimmer rounded bg-[var(--bg-elev-1)]" />
                </th>
              ))}
            </tr>
          </thead>
...
export function DashboardSkeleton() {
  return (
    <div className="rounded-lg border border-[var(--border-subtle)] bg-[var(--bg-elev-1)] p-6 shadow-xl">
      {/* Title skeleton */}
      <div className="mb-6 h-8 w-48 animate-shimmer rounded bg-[var(--bg-elev-2)]" />
      ...
      <div className="rounded-lg border border-[var(--border-subtle)] bg-[var(--bg-elev-2)] p-5 shadow-md">
        <div className="mb-4 h-6 w-32 animate-shimmer rounded bg-[var(--bg-elev-1)]" />
  ...
  return (
    <div className="rounded-lg border border-[var(--border-subtle)] bg-[var(--bg-elev-1)] p-6 shadow-xl">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div className="h-8 w-48 animate-shimmer rounded bg-[var(--bg-elev-2)]" />
        <div className="flex space-x-2">
          <div className="h-10 w-48 animate-shimmer rounded bg-[var(--bg-elev-2)]" />
          <div className="h-10 w-20 animate-shimmer rounded bg-[var(--bg-elev-2)]" />
        </div>
      </div>
...
export function UsersTabSkeleton() {
  return (
    <div className="rounded-lg border border-[var(--border-subtle)] bg-[var(--bg-elev-1)] p-6 shadow-xl">
      {/* Header with title and search */}
      <div className="mb-6 flex items-center justify-between">
        <div className="h-8 w-44 animate-shimmer rounded bg-[var(--bg-elev-2)]" />
        <div className="flex space-x-2">
          <div className="h-10 w-48 animate-shimmer rounded bg-[var(--bg-elev-2)]" />
          <div className="h-10 w-20 animate-shimmer rounded bg-[var(--bg-elev-2)]" />
        </div>
