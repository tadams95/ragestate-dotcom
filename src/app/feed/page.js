...
export default function FeedPage() {
  return (
    <div className="isolate min-h-screen bg-black px-4 pb-12 pt-24 text-white supports-[padding:env(safe-area-inset-bottom)]:pb-[max(48px,env(safe-area-inset-bottom))] sm:px-6 sm:pb-24 lg:px-8">
